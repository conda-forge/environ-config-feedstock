...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/environ-config-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12658&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/environ-config-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `environ-config` can be installed with:

```
conda install environ-config
```

It is possible to list all of the versions of `environ-config` available on your platform with:
